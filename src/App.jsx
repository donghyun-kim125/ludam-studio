...
export default function App() {
  ...
  return (
    <div className="app-container">
        ...
        <div className="footer-container">
          ...
          <div className="footer-links-grid">
            ...
            <div className="footer-links-col">
              ...
              <a href="#" className="footer-link" onClick={(e) => openModal('privacy', e)} id="link-privacy">Privacy Policy</a>
      ...
      {/* Legal Modals (Ludam Studio Terms Template - English Version) */}
      {activeModal && (
            ...
            <div className="modal-body">
              {activeModal === 'privacy' ? (
                <>
                  ...
                  <p>Email: <a href="mailto:studio.ludam@gmail.com" style={{ color: '#7c3aed' }}>studio.ludam@gmail.com</a></p>
                </>
              ) : (
                <>
                  <p><strong>Effective Date: May 17, 2026</strong></p>
